...
tags = {
   names = { "1","2","3" },
   layout = { layouts[2], layouts[1], layouts[10] }
}
...
menu_office = {
  {" Wps 文字",        "wps", beautiful.librewriter_icon},
  {" Wps 表格",        "et", beautiful.librecalc_icon},
  {" Wps 演示",        "wpp", beautiful.libredraw_icon}
}

menu_graphics = {
  {" Gimp",             "gimp",beautiful.gwenview_icon},
...
menu_editor =  {
							  {" WPS",menu_office,beautiful.librewriter_icon},
							  {" Graphics",menu_graphics,beautiful.gwenview_icon},
							  {" QTCreator",      "qtcreator"},
							  {" Docear",         "docear"},
							  {" Leafpad",        "leafpad"},
							  {" Texmaker",       "texmaker"},
...
--  {" Dolphin",              filemanager, beautiful.spacefm_icon},
  {"Awesome",              myawesomemenu, beautiful.awesome_icon },
  {" 多媒体",                menu_multimedia, beautiful.menu_multimedia_icon},
  {" 互联网",             menu_web, beautiful.menu_web_icon},
  {" 编辑器",               menu_editor, beautiful.librewriter_icon},
  {" 终  端",                terminal, beautiful.terminal_icon},
  {" 关  机", 	            "/usr/local/bin/shutdown_dialog.sh",beautiful.shutdown_icon},
  {" 取  消",                "",beautiful.books_c_icon}
}
...
-- ALSA volume control
    ...
    -- User programs
    awful.key({ "Control", altkey }, "q", function () awful.util.spawn(browser) end),
    awful.key({ "Control", altkey }, "i", function () awful.util.spawn(browser2) end),
    awful.key({ "Control", altkey }, "e", function () awful.util.spawn(gui_editor) end),
    awful.key({ "Control", altkey }, "g", function () awful.util.spawn(graphics) end),
    awful.key({ "Control", altkey }, "o", function () awful.util.spawn(filemanager) end)
